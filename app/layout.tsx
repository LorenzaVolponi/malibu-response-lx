  ...
  '@graph': [
    {
      ...
      description: `Site oficial do anúncio da ${siteConfig.listingName} ${boat.year}, com dossiê técnico, guias e dados estruturados da embarcação.`,
      inLanguage: 'pt-BR',
    ...
    },
    {
      ...
      manufacturer: { '@type': 'Organization', name: 'Indmar Marine Engines' },
      additionalProperty: [
