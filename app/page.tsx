...
const productJsonLd = {
  ...
  description: 'Malibu Response LX 2013 à venda, lancha ideal para esqui aquático e wakeboard com motor Indmar Monsoon 350 SS V8 de 350 HP, transmissão direct drive e controle de velocidade Zero Off GPS.',
  ...
  additionalProperty: [
    ...
    { '@type': 'PropertyValue', name: 'Esportes indicados', value: 'Esqui aquático e wakeboard recreativo' },
    { '@type': 'PropertyValue', name: 'Item incluso', value: 'Toldo bimini' },
