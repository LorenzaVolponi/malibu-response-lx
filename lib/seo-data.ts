...
export const offPagePlaybook = [
  'Cadastrar e manter consistência de nome, telefone e URL em marketplaces náuticos, marinas, clubes, grupos locais e perfis sociais do vendedor.',
  'Publicar vídeos curtos reais do motor, painel, casco, estofamento, carreta e saída na água apontando para a página canônica do anúncio.',
  'Usar o mesmo link canônico em bio, posts, YouTube/Shorts, Instagram/Reels, grupos de wake/esqui e listas de barcos usados, sem compra de links ou automações de spam.',
  'Pedir que qualquer indicação externa use descrições naturais como “Malibu Response LX 2013 à venda” e não listas artificiais de palavras-chave.',
] as const

export const trustSignals = [
  'Preço publicado: R$ 175.000',
  'Ano de fabricação: 2013',
  'Horas de motor informadas: 940 h',
