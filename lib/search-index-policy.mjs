...
export const SUPPORT_ONLY_GUIDE_SLUGS = Object.freeze([
  // The homepage is the primary commercial URL for the exact
  // "Malibu Response LX à venda" intent. Keep this near-duplicate guide
  // crawlable for internal discovery, but out of the search index so the
  // listing does not compete with itself for the same transactional query.
